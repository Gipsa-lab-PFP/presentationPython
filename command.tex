...
%_______________________________________________________________________________
%_______________________________________________________________________________
\lstdefinestyle{myPythonConsole}{language=python, keywordstyle=\color{blue}, commentstyle=\color{red}, basicstyle=\tiny \ttfamily, stringstyle=\color{magenta} \ttfamily, backgroundcolor=\color{pythonBackground}, texcl=true, escapechar=£, showstringspaces=false}
%_______________________________________________________________________________
%_______________________________________________________________________________
